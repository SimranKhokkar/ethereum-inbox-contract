...
const bytecode = output.contracts[':Inbox'].bytecode;
const abi = JSON.parse(output.contracts[':Inbox'].interface);
 ...
 */
 ...
 contract.new('hey', {data: '0x' + bytecode, from: "0x15ccc38776d61c6d5a3ebf2237a70af5b070d52c", gas: gasEstimate}, (err,res) => {
if(err) {
    console.log(err);
    return;
} else {
